...
object CollectionDemo {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(299); 
  ...
  //以下操作等价
  left union right;System.out.println("""res0: List[Int] = """ + $show(res$0));$skip(39); val res$1 = 
  left ++ right;System.out.println("""res1: List[Int] = """ + $show(res$1));$skip(39); val res$2 =    // List(1,2,3,4,5,6)
